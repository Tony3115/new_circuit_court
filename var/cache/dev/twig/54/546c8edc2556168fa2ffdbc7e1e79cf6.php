...
class __TwigTemplate_e60f9ea7127d400ad87eda4d3a80face extends Template
{
    ...
    <table class=\"table\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 24
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 24, $this->source); })()), "image", [], "any", false, false, false, 24), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                <th>Date_create</th>
...
{% endblock %}
", "category/show.html.twig", "C:\\laragon\\www\\new_circuit_court\\templates\\category\\show.html.twig");
    }
}
